...
<body>
    ...
    $orders = "update orders set txnid='$txnid' where order_id='$orderid'";
    mysqli_query($con, $orders);
    $posted['amount'] = $_GET['totalamount'];
    $posted['firstname'] = $_SESSION['name'];
    $posted['email'] = $_GET['email'];
    $posted['phone'] = $_GET['mobile'];
